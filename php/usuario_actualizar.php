<?php
    ...
    $actualizar_usuario=$mysqli_stmt->prepare("UPDATE usuario SET usuario_nombre=?,usuario_apellido=?,usuario_usuario=?,usuario_clave=?,usuario_email=? WHERE usuario_id=?");
    $actualizar_usuario->bind_param('sssssi', $nombre, $apellido, $usuario, $clave, $email, $id);
